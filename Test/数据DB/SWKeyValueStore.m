...
@implementation SWKeyValueItem


@end

@interface SWKeyValueStore ()

@property (strong, nonatomic) FMDatabaseQueue * dbQueue;

@end

@implementation SWKeyValueStore
...
+ (instancetype)sharedInstance {
    ...
    static SWKeyValueStore *sharedInstance = nil;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[SWKeyValueStore alloc] initDBWithName:@"SW.db"];
    });
...
- (id)getObjectById:(NSString *)objectId fromTable:(NSString *)tableName {
    SWKeyValueItem * item = [self getYTKKeyValueItemById:objectId fromTable:tableName];
    if (item) {
...
- (SWKeyValueItem *)getYTKKeyValueItemById:(NSString *)objectId fromTable:(NSString *)tableName {
    ...
    if (json) {
        ...
        SWKeyValueItem * item = [[SWKeyValueItem alloc] init];
...
- (NSArray *)getAllItemsFromTable:(NSString *)tableName {
    ...
    NSError * error;
    for (SWKeyValueItem * item in result) {
        error = nil;
